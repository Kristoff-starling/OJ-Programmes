...
struct Matrix
{
    ...
    void I() {memset(b,0,sizeof(b));rep(i,1,2) b[i][i]=1;}
    Matrix operator + (Matrix other)
    {
        Matrix res;
        rep(i,1,2) rep(j,1,2) res.b[i][j]=add(b[i][j]+other.b[i][j]);
        return res;
    }
    Matrix operator * (Matrix other)
    {
...
int main ()
{
    ...
    Matrix st;st.b[1][1]=2;st.b[2][1]=1;
    Matrix trans;trans.b[1][1]=trans.b[1][2]=trans.b[2][1]=1;
    st=quick_pow(trans,n-2)*st;
    printf("%d\n",st.b[1][1]);
#ifndef ONLINE_JUDGE
